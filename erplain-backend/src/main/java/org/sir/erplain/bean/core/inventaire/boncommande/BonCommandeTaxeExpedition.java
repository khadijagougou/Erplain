...
*/
@Entity
@Table(name="boncommandetaxeexpedition")
public class BonCommandeTaxeExpedition {
@Id
...
@ManyToOne(fetch = FetchType.LAZY)
private Taxe taxe;
public BonCommandeTaxeExpedition() {
}
public Long getId() {
return id;
}
...
if (object instanceof BonCommandeTaxeExpedition bonCommandeTaxeExpedition) {
return bonCommandeTaxeExpedition.getId().equals(this.getId());
}
return false;
}
@Override
